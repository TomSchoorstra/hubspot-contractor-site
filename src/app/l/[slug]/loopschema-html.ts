...
const PLAN_DENISE = [
 {w:1, fase:"Basis", focus:"Ambitieuze start! Vaste 3× per week: een rustige run, een kwaliteitssessie en een long run. Rustige km's blijven op praattempo. Knie in de gaten houden.",
  runs:[{t:"e",km:6,n:"Rustige run"},{t:"q",km:6,n:"Rustig + strides",steps:["Loop ongeveer 4,5 km rustig op 6:30–6:55/km. Houd dit echt op praattempo.","Doe daarna 6 × 20 seconden vloeiend versnellen.","Bouw iedere stride geleidelijk op. Loop snel en soepel, maar sprint niet.","Wandel of jog na iedere stride 60–90 seconden zeer rustig en herstel volledig.","Loop na de laatste stride rustig verder totdat je 6 km totaal hebt bereikt."],why:"Dit is de lichtste vorm van snelheidswerk. De korte versnellingen maken je benen wakker en helpen je looptechniek, zonder de belasting van een echte intervaltraining. Alle strides moeten ontspannen en technisch netjes voelen. Voel je de knie, sla de resterende strides over en loop rustig uit.",q:{plannedDistanceKm:6,blocks:[{type:"warmup",distanceKm:4.5},{type:"repeat",repetitions:6,durationSeconds:20},{type:"recovery",repetitions:5,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:6}]}},{t:"l",km:9,n:"Duurloop"}]},
 {w:2, fase:"Basis", focus:"Long run tikt 10 km aan. Eerste echte intervalletjes, gedoseerd. Voelt de knie iets, minder dan of stop.",
  runs:[{t:"e",km:7,n:"Rustige run"},{t:"q",km:6,n:"Intervallen",steps:["Loop 1,5 km rustig in op 6:30–6:55/km.","Loop 5 × 400 meter op 5:15–5:30/km.","Jog na herhaling 1 tot en met 4 telkens 90 seconden zeer rustig. Wandel wanneer dat nodig is om voldoende te herstellen.","Loop na de laatste 400 meter rustig verder totdat je 6 km totaal hebt bereikt."],why:"Dit is de eerste echte intervaltraining van het schema. De herhalingen zijn bewust kort. Loop alle vijf de 400 meters ongeveer even snel. De eerste herhaling mag niet de snelste zijn. Zakt het tempo gedurende de sessie sterk weg, dan is er te snel gestart. Stop het snelle gedeelte bij duidelijke kniepijn.",q:{plannedDistanceKm:6,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:5,distanceKm:0.4},{type:"recovery",repetitions:4,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:6}]}},{t:"l",km:10,n:"Duurloop"}]},
 {w:3, fase:"Basis", herstel:true, focus:"Herstelweek. Volume omlaag zodat de benen en de knie bijtanken. Kwaliteit blijft licht.",
  runs:[{t:"e",km:6,n:"Rustige run"},{t:"q",km:5,n:"Rustig + strides",steps:["Loop ongeveer 3,5 km heel ontspannen.","Doe daarna 4 × 20 seconden vloeiend versnellen.","Wandel of jog na iedere stride ruim voldoende om volledig te herstellen.","Loop na de laatste stride rustig verder totdat je 5 km totaal hebt bereikt."],why:"Dit is een herstelweek. Alles moet gemakkelijk blijven voelen. De strides houden wat snelheid en souplesse in de benen, maar mogen geen vermoeidheid veroorzaken. Speelt de knie op, sla de strides volledig over en maak er een rustige duurloop van.",q:{plannedDistanceKm:5,blocks:[{type:"warmup",distanceKm:3.5},{type:"repeat",repetitions:4,durationSeconds:20},{type:"recovery",repetitions:3,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:5}]}},{t:"l",km:8,n:"Duurloop"}]},
 {w:4, fase:"Opbouw", focus:"Weer omhoog. Long run 11 km, intervallen iets langer.",
  runs:[{t:"e",km:7,n:"Rustige run"},{t:"q",km:7,n:"Intervallen",steps:["Loop 1,5 km rustig in op 6:30–6:55/km.","Loop 6 × 400 meter op 5:15–5:30/km.","Jog na herhaling 1 tot en met 5 telkens 90 seconden zeer rustig. Wandel wanneer nodig.","Loop na de laatste 400 meter rustig verder totdat je 7 km totaal hebt bereikt."],why:"Deze sessie bouwt voort op de vijf herhalingen uit week 2. Het doel is niet om één herhaling uitzonderlijk snel te lopen, maar om alle zes de blokken gelijkmatig uit te voeren. Kan de zesde ongeveer even snel als de eerste, dan was de inspanning goed verdeeld. Stop bij duidelijke kniepijn.",q:{plannedDistanceKm:7,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:6,distanceKm:0.4},{type:"recovery",repetitions:5,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:7}]}},{t:"l",km:11,n:"Duurloop"}]},
 {w:5, fase:"Opbouw", focus:"Eerste tempoblokken: aaneengesloten iets sneller lopen. Long run 12 km.",
  runs:[{t:"e",km:7,n:"Rustige run"},{t:"q",km:7,n:"Tempo",steps:["Loop 1,5 km rustig in.","Loop 3 × 5 minuten op 5:40–5:55/km.","Jog tussen de tempoblokken 2,5 minuut zeer rustig. Wandel wanneer dat nodig is om het volgende blok gecontroleerd te starten.","Loop na het derde tempoblok rustig verder totdat je 7 km totaal hebt bereikt."],why:"Dit is de overgang van korte intervallen naar langere tempoblokken. Het tempo moet comfortabel zwaar voelen: Denise kan nog enkele woorden uitspreken, maar geen volledig gesprek voeren. De training is geen testwedstrijd. Na het derde blok moet er nog controle over zijn.",q:{plannedDistanceKm:7,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:3,durationSeconds:300},{type:"recovery",repetitions:2,durationSeconds:150,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:7}]}},{t:"l",km:12,n:"Duurloop"}]},
 {w:6, fase:"Opbouw", focus:"Langere intervallen (600m). Long run 13 km. Neem water/gel mee op de long run.",
  runs:[{t:"e",km:8,n:"Rustige run"},{t:"q",km:8,n:"Intervallen",steps:["Loop 2 km rustig in.","Loop 5 × 600 meter op 5:15–5:30/km.","Jog na herhaling 1 tot en met 4 telkens 90 seconden zeer rustig. Wandel wanneer nodig.","Loop na de laatste 600 meter rustig verder totdat je 8 km totaal hebt bereikt."],why:"De herhalingen zijn langer dan de eerdere 400 meters. Daardoor wordt hetzelfde snelle tempo langer vastgehouden. Verdeel de inspanning zo dat iedere 600 meter technisch netjes blijft en ongeveer even snel gaat. Deze sessie belast de knie meer dan de korte intervallen, dus stop het snelle gedeelte bij duidelijke pijn.",q:{plannedDistanceKm:8,blocks:[{type:"warmup",distanceKm:2},{type:"repeat",repetitions:5,distanceKm:0.6},{type:"recovery",repetitions:4,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:8}]}},{t:"l",km:13,n:"Duurloop"}]},
 {w:7, fase:"Opbouw", herstel:true, focus:"Herstelweek. Gas terug na drie weken opbouwen.",
  runs:[{t:"e",km:6,n:"Rustige run"},{t:"q",km:6,n:"Rustig + strides",steps:["Loop ongeveer 4,5 km ontspannen.","Doe daarna 4–6 × 20 seconden vloeiend versnellen.","Wandel of jog na iedere stride ruim voldoende om volledig te herstellen.","Loop na de laatste stride rustig verder totdat je 6 km totaal hebt bereikt."],why:"Dit is een herstelweek. De strides houden snelheid en souplesse in de benen zonder een zware trainingsprikkel te geven. Het aantal mag tussen vier en zes liggen, afhankelijk van herstel en kniegevoel. Voelt de knie niet goed, sla de strides over.",q:{plannedDistanceKm:6,blocks:[{type:"warmup",distanceKm:4.5},{type:"repeat",repetitions:6,durationSeconds:20},{type:"recovery",repetitions:5,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:6}]}},{t:"l",km:10,n:"Duurloop"}]},
 {w:8, fase:"Opbouw", focus:"Langere tempoblokken. Long run 14 km. Test alvast je race-ontbijt en drinken onderweg.",
  runs:[{t:"e",km:8,n:"Rustige run"},{t:"q",km:8,n:"Tempo",steps:["Loop 2 km rustig in.","Loop 2 × 10 minuten op 5:40–5:55/km.","Jog tussen de twee blokken 3 minuten zeer rustig. Wandel wanneer nodig.","Loop na het tweede tempoblok rustig verder totdat je 8 km totaal hebt bereikt."],why:"De tempoblokken zijn langer dan in week 5. Het doel is leren een stevig, gecontroleerd tempo langer vast te houden. Begin het eerste blok liever iets te rustig dan te snel. De laatste minuten mogen focus vragen, maar de loopvorm en controle moeten behouden blijven.",q:{plannedDistanceKm:8,blocks:[{type:"warmup",distanceKm:2},{type:"repeat",repetitions:2,durationSeconds:600},{type:"recovery",repetitions:1,durationSeconds:180,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:8}]}},{t:"l",km:14,n:"Duurloop"}]},
 {w:9, fase:"Opbouw", focus:"Long run 15 km, nieuw terrein. Intervallen op 600m.",
  runs:[{t:"e",km:9,n:"Rustige run"},{t:"q",km:8,n:"Intervallen",steps:["Loop 1,5 km rustig in.","Loop 6 × 600 meter op 5:15–5:30/km.","Jog na herhaling 1 tot en met 5 telkens 90 seconden zeer rustig. Wandel wanneer nodig.","Loop na de laatste 600 meter rustig verder totdat je 8 km totaal hebt bereikt."],why:"Dit is de zwaarste intervaltraining van het schema. Gelijkmatigheid is belangrijker dan een zeer snelle eerste herhaling. Alle zes de blokken moeten ongeveer binnen dezelfde tempomarge blijven. Door de combinatie van snelheid en langere herhalingen is dit ook een relatief zware sessie voor de knie. Stop het snelle gedeelte zodra daar duidelijke pijn ontstaat.",q:{plannedDistanceKm:8,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:6,distanceKm:0.6},{type:"recovery",repetitions:5,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:8}]}},{t:"l",km:15,n:"Duurloop"}]},
 {w:10, fase:"Opbouw", focus:"Long run 16 km. Stevige tempoblokken. Mooie mijlpaal richting de halve.",
  runs:[{t:"e",km:9,n:"Rustige run"},{t:"q",km:9,n:"Tempo",steps:["Loop 2 km rustig in.","Loop 3 × 8 minuten op 5:40–5:55/km.","Jog tussen de blokken 3 minuten zeer rustig. Wandel wanneer dat nodig is.","Loop na het derde blok rustig verder totdat je 9 km totaal hebt bereikt."],why:"Met 24 minuten tempowerk is dit de grootste drempeltraining van de opbouwfase. De eerste twee blokken moeten beheerst blijven, zodat ook het derde blok technisch goed kan worden afgerond. Wanneer het tempo in het laatste blok niet meer haalbaar is, moet Denise niet forceren. Noteer hoe het ging; dat zegt iets over herstel en belastbaarheid.",q:{plannedDistanceKm:9,blocks:[{type:"warmup",distanceKm:2},{type:"repeat",repetitions:3,durationSeconds:480},{type:"recovery",repetitions:2,durationSeconds:180,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:9}]}},{t:"l",km:16,n:"Duurloop"}]},
 {w:11, fase:"Opbouw", herstel:true, focus:"Herstelweek vóór de piek. Fris worden.",
  runs:[{t:"e",km:7,n:"Rustige run"},{t:"q",km:7,n:"Rustig + strides",steps:["Loop ongeveer 5,5 km ontspannen.","Doe daarna 4–6 × 20 seconden vloeiend versnellen.","Wandel of jog na iedere stride ruim voldoende om volledig te herstellen.","Loop na de laatste stride rustig verder totdat je 7 km totaal hebt bereikt."],why:"Dit is de laatste herstelweek voor de piekfase. De training moet energie geven in plaats van kosten. Ga niet sneller of langer lopen omdat de benen goed voelen. Het belangrijkste doel is fris aan de volgende twee weken beginnen. Bij knieklachten vervallen de strides.",q:{plannedDistanceKm:7,blocks:[{type:"warmup",distanceKm:5.5},{type:"repeat",repetitions:6,durationSeconds:20},{type:"recovery",repetitions:5,durationSeconds:90,mode:"walk_or_jog"},{type:"cooldown",untilTotalDistanceKm:7}]}},{t:"l",km:13,n:"Duurloop"}]},
 {w:12, fase:"Piek", focus:"Piekfase. Racetempo-blokken: oefenen op je doeltempo (~6:00). Long run 17 km.",
  runs:[{t:"e",km:9,n:"Rustige run"},{t:"q",km:12,n:"Racetempo",steps:["Loop 2 km rustig in.","Loop 3 × 2 km op ongeveer 6:00/km.","Jog tussen de blokken 3 minuten zeer rustig. Wandel wanneer nodig.","Loop na het derde blok rustig verder totdat je 12 km totaal hebt bereikt."],why:"Deze training oefent het beoogde wedstrijdtempo zonder onnodig veel belasting te veroorzaken in de week van de 17 km long run. Het racetempo moet gecontroleerd voelen en mag niet als een maximale tempotraining worden gelopen. De drie blokken moeten ongeveer gelijkmatig zijn. Voelt 6:00/km vanaf het eerste blok al uitzonderlijk zwaar, forceer het tempo dan niet en noteer hoe de sessie verliep.",q:{plannedDistanceKm:12,blocks:[{type:"warmup",distanceKm:2},{type:"repeat",repetitions:3,distanceKm:2},{type:"recovery",repetitions:2,durationSeconds:180,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:12}]}},{t:"l",km:17,n:"Duurloop"}]},
 {w:13, fase:"Piek", focus:"De langste van het schema: 18 km. Langere racetempo-blokken. Hierna weet je: de afstand komt eraan.",
  runs:[{t:"e",km:9,n:"Rustige run"},{t:"q",km:11,n:"Racetempo",steps:["Loop 2 km rustig in.","Loop 2 × 3 km op ongeveer 6:00/km.","Jog tussen de twee blokken 3 minuten zeer rustig. Wandel wanneer nodig.","Loop na het tweede blok rustig verder totdat je 11 km totaal hebt bereikt."],why:"Dit is de laatste grote specifieke racetempotraining. De blokken zijn lang genoeg om het wedstrijdritme te oefenen, maar korter dan in het oude schema omdat deze week ook de 18 km long run bevat. De training moet gecontroleerd blijven. Verdeel de energie over de hele week en stop het snelle gedeelte bij duidelijke kniepijn of uitzonderlijke vermoeidheid.",q:{plannedDistanceKm:11,blocks:[{type:"warmup",distanceKm:2},{type:"repeat",repetitions:2,distanceKm:3},{type:"recovery",repetitions:1,durationSeconds:180,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:11}]}},{t:"l",km:18,n:"Duurloop — langste!"}]},
 {w:14, fase:"Taper", focus:"Taper: volume flink omlaag, beetje scherpte erin houden. Je wordt hier fitter zonder hard te trainen.",
  runs:[{t:"e",km:6,n:"Rustige run"},{t:"q",km:6,n:"Tempo",steps:["Loop 1,5 km rustig in.","Loop 2 × 1,5 km op 5:40–5:55/km.","Jog tussen de twee blokken 3 minuten zeer rustig. Wandel wanneer nodig.","Loop na het tweede blok rustig verder totdat je 6 km totaal hebt bereikt."],why:"Het trainingsvolume gaat tijdens de taper duidelijk omlaag, maar er blijft een kleine tempoprikkel aanwezig. De blokken moeten soepel en gecontroleerd voelen. Dit is niet het moment om conditie te testen of extra werk toe te voegen. Frisheid voor de race is belangrijker dan één zware training.",q:{plannedDistanceKm:6,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:2,distanceKm:1.5},{type:"recovery",repetitions:1,durationSeconds:180,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:6}]}},{t:"l",km:10,n:"Duurloop"}]},
 {w:15, fase:"Race", focus:"Raceweek! Alles kort en fris. Niets nieuws op de dag zelf. Start rustig, de eerste kilometers moeten bijna te makkelijk voelen. Geniet ervan!",
  runs:[{t:"e",km:5,n:"Rustige run"},{t:"q",km:4,n:"Opfrisser",steps:["Loop 1,5 km rustig in.","Loop 3 × 500 meter op ongeveer 6:00/km.","Jog na herhaling 1 en 2 telkens 90 seconden zeer rustig. Wandel wanneer nodig.","Loop na de derde herhaling rustig verder totdat je 4 km totaal hebt bereikt."],why:"Dit is uitsluitend een korte race-opfrisser. De bedoeling is om het wedstrijdtempo nog één keer soepel te voelen zonder vermoeidheid op te bouwen. Alle herhalingen moeten gemakkelijk en vertrouwd aanvoelen. Voeg geen extra herhalingen, strides of kilometers toe. Niets nieuws proberen met schoenen, voeding of materiaal.",q:{plannedDistanceKm:4,blocks:[{type:"warmup",distanceKm:1.5},{type:"repeat",repetitions:3,distanceKm:0.5},{type:"recovery",repetitions:2,durationSeconds:90,mode:"jog_or_walk"},{type:"cooldown",untilTotalDistanceKm:4}]}},{t:"r",km:21.1,n:"🏁 HALVE MARATHON"}]}
];
// Afgesproken weektotalen Denise (mogen niet verschuiven door de quality-update).
const EXPECTED_WEEK_TOTALS_DENISE = [21,23,19,25,26,29,22,30,32,34,27,38,38,22,30.1];

// Zuivere, DOM-vrije validator voor Denise' kwaliteitssessies. Zelfde blok-checks
// als bij Tom, maar zonder de stabiele-id/42-sessie/5K-test-eisen (Denise = positioneel).
// Extra harde check: recovery.repetitions === repeat.repetitions - 1 (herstel alléén
// tussen de herhalingen, nooit na de laatste). Wordt zowel client-side (console.warn)
// als door scripts/validate-denise-plan.mjs (blokkerend) gebruikt.
function collectDenisePlanErrors(plan){
  const errors = [];
  plan.forEach(function(w, wi){
    let weekTotal = 0;
    w.runs.forEach(function(r, i){
      ...
      if(r.q.plannedDistanceKm !== r.km) errors.push(id + ": q.plannedDistanceKm (" + r.q.plannedDistanceKm + ") != r.km (" + r.km + ")");
      let fixedKm = 0, hasTimeBased = false, hasCooldownFill = false, repeatReps = null, recoveryReps = null;
      r.q.blocks.forEach(function(b){
        if(b.type === "cooldown" && b.untilTotalDistanceKm != null) hasCooldownFill = true;
        if(b.type === "repeat" && b.repetitions != null) repeatReps = b.repetitions;
        if(b.type === "recovery") recoveryReps = (b.repetitions != null ? b.repetitions : null);
        if(b.distanceKm == null){ hasTimeBased = true; return; }
        if(b.type === "repeat") fixedKm += b.distanceKm * (b.repetitions || 1);
        else if(b.type === "recovery") fixedKm += b.distanceKm * (b.repetitions != null ? b.repetitions : 0);
        else fixedKm += b.distanceKm;
      });
      if(fixedKm > r.q.plannedDistanceKm + 0.05) errors.push(id + ": vaste afstandsblokken (" + fixedKm.toFixed(2) + "km) groter dan geplande sessieafstand (" + r.q.plannedDistanceKm + "km)");
      if(hasTimeBased && !hasCooldownFill) errors.push(id + ": tijdgebaseerde Q-sessie zonder cooling-down tot totaalafstand");
      if(repeatReps != null && recoveryReps != null && recoveryReps !== repeatReps - 1) errors.push(id + ": recovery.repetitions (" + recoveryReps + ") != repeat.repetitions - 1 (" + (repeatReps - 1) + ") — herstel hoort alleen tussen de herhalingen");
    });
    const expected = EXPECTED_WEEK_TOTALS_DENISE[wi];
    if(expected == null) errors.push("Week " + w.w + ": geen afgesproken weektotaal gedefinieerd");
    else if(Math.abs(weekTotal - expected) > 0.05) errors.push("Week " + w.w + ": weektotaal " + weekTotal.toFixed(1) + "km wijkt af van afgesproken " + expected + "km");
  });
  return errors;
...
(function(){
  try{
    if(LOOP.rowId === "denise"){
      const errs = collectDenisePlanErrors(PLAN_DENISE);
      if(errs.length) console.warn("[loopschema] PLAN_DENISE validatie:", errs);
    }
  }catch(e){ console.warn("[loopschema] Denise-validatie crashte:", e); }
})();
