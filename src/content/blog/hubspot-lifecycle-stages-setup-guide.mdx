...
If you're starting from scratch, also read [the most common HubSpot onboarding mistakes I see](/blog/hubspot-onboarding-mistakes) — mistake #4 is directly about lifecycle and deal stage setup.
...
For deal stage setup specifically, [pipeline optimization](/services/pipeline-optimization) is one of the things I help teams get right.
...
If you need help building those workflows, [HubSpot automation setup](/services/automation) is one of the things I can help with.
...
See also: [the most common HubSpot onboarding mistakes](/blog/hubspot-onboarding-mistakes), specifically mistake #4 on wrong lifecycle and deal stages.
