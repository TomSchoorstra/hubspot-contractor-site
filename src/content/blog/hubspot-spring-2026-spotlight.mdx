...
[INTERNAL-LINK: how to set up Breeze Customer Agent → future article on HubSpot automation setup]
...
[INTERNAL-LINK: setting up HubSpot Data Hub for small teams → future article on data operations]
...
[INTERNAL-LINK: what are HubSpot custom app cards → Cluster 5 article on app cards]
...
[INTERNAL-LINK: classic CRM cards sunset migration guide → future article on app cards migration]
